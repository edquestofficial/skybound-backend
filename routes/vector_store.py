...
def process_registration_object(username: str, name: str, photos: List[UploadFile]) -> dict:
    """
...
def create_embedding_for_file(username: str, name: str, image_path: str, image_index: int) -> dict:
    """
